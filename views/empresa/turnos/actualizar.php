...
<form class="formulario-carga" method="post" action="/empresa/turnos/actualizar?idServicio=<?php echo htmlspecialchars($turno->idServicio, ENT_QUOTES, 'UTF-8'); ?>">
    <div class="contenido">
        <div class="campo">
...
<br>
<a href="../index" class="btn">No quiero generar cambios aquí.</a>
<br>
<br>